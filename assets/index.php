...
<html lang="en">
<head>
<title>Brilliance An Education Category Flat Bootstrap Responsive Website Template | Home :: w3layouts</title>
<!-- for-mobile-apps -->
	...
	<div class="header-w3ls-agileinfo">
			...
			<div class="wthree_agile_top_header">
				<div class="logo-agileits">
					<h1><a href="index.html"><span>B</span>rilliance <i class="fa fa-graduation-cap" aria-hidden="true"></i></a></h1>
				</div>
...
<!-- banner-bottom -->
	<div class="banner-bottom-agileits" id="about">
			...
			<div class="col-md-7 w3l_banner_bottom_left">
				...
				<p>Nullam at turpis vel sapien aliquam feugiat vitae vitae mi. 
