...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<div class="wrapper">
		...
		<aside class="main-sidebar">
			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu" data-widget="tree">
					...
					$main_menu = $this->db->query("SELECT * FROM menu WHERE main_menu = 0 AND level != 'kepsek';");
					foreach ($main_menu->result() as $main) {
						// Query untuk mencari data sub menu
						// $sub_menu = $this->db->get_where('menu', array('main_menu' => $main->id_menu));
						$sub_menu = $this->db->query("SELECT * FROM menu WHERE main_menu = $main->id_menu AND level != 'kepsek';");
					...
					<div class="box box-default color-palette-box">
						...
						<div class="box-body">
							<div class="row">
								...
								<!-- /.col -->
								<div class="col-sm-4 col-md-2">
									<h4 class="text-center"><span class="info-box-text">Angkatan</span></h4>
									<div class="color-palette-set">
										<a href="<?php echo site_url('angkatan') ?>">
											<center><i class="fa fa-ellipsis-v" style="font-size:48px;color:#3c8dbc"></i>
												<center>
										</a>
									</div>
								</div>
								<!-- /.col -->
								<div class="col-sm-4 col-md-2">
									<h4 class="text-center"><span class="info-box-text">INPUT RENCANA PENGAJARAN</span></h4>
									<div class="color-palette-set">
								...
								<div class="col-sm-4 col-md-2">
									...
									<div class="color-palette-set">
										<a href="<?php echo site_url('nilai/inputNilai') ?>">
							...
							<div class="row">
								...
								<!-- /.col -->
								<div class="col-sm-4 col-md-2">
									<h4 class="text-center"><span class="info-box-text">Info Sekolah</span></h4>
									<div class="color-palette-set">
								...
								<!-- /.col -->
								<div class="col-sm-4 col-md-2">
									<h4 class="text-center"><span class="info-box-text">Tentang Sekolah</span></h4>
									<div class="color-palette-set">
		...
		<footer class="main-footer">
			...
			<strong>Copyright &copy; 2020-2021 <a href="#">SPN POLDA LAMPUNG</a>.</strong> All rights
			reserved.
		</footer>
			...
			CometChatWidget.init({
				...
				CometChatWidget.login({
					...
					CometChatWidget.launch({
						"widgetID": "4b9554f8-f9d8-42bd-b10d-9ee6143dcc26",
						"docked": "true",
