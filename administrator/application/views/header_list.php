...
<head>
  ...
  <!-- ClockPicker -->
  <link rel="stylesheet" href="<?php echo base_url('assets/bower_components/clockpicker/dist/jquery-clockpicker.css') ?>">
  <link rel="stylesheet" href="<?php echo base_url('assets/bower_components/clockpicker/dist/bootstrap-clockpicker.css') ?>">
  <link rel="stylesheet" href="<?php echo base_url('assets/bower_components/clockpicker/src/clockpicker.css') ?>">
  <link rel="stylesheet" href="<?php echo base_url('assets/bower_components/clockpicker/src/standalone.css') ?>">
  <!-- Theme style -->
