...
class Siswa extends CI_Controller
{
	...
	public function index()
	{
		...
		$this->load->view('siswa/siswa_list'); // Menampilkan halaman utama mahasiswa
	...
	// Fungsi menampilkan form Create siswa
	public function create()
	{
		...
		$this->load->view('header', $dataAdm); // Menampilkan bagian header dan object data users 	 
		$this->load->view('siswa/siswa_form', $data); // Menampilkan halaman form mahasiswa
		$this->load->view('footer'); // Menampilkan bagian footer
	}
	...
	{
		$kode_angkatan = $this->db->get_where('angkatan', ['aktif' => 'Y'])->row()->kode_angkatan;
		// Jika session data username tidak ada maka akan dialihkan kehalaman login			
		if (!isset($this->session->userdata['username'])) {
			redirect(base_url("login"));
		}
