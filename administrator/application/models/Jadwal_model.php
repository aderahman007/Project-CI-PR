...
class Jadwal_model extends CI_Model
{
    ...
    function json()
    {
        ...
        $this->datatables->select("j.id_jadwal,j.hari, j.jam_mulai, j.jam_selesai, p.nama_pelajaran, g.nama_guru, k.nama_kelas");
        ...
        $this->datatables->join('angkatan as t', 'j.kode_angkatan = t.kode_angkatan');
