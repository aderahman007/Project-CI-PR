<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Laporan Pengumuman</li>
    </ol>
</section>
<!-- Main content -->
<section class="content">
    ...
    <div class="box">
        <div class="box-body">
            ...
            <!-- Tampil Data Laporan Pengumuman -->
            <div class="row" style="margin-bottom: 10px">
                <div class="col-md-4">
                    <h2 style="margin-top:0px">Laporan Pengumuman</h2>
                </div>
            ...
            <script type="text/javascript">
                $(document).ready(function() {
                    ...
                    var t = $("#mytable").dataTable({
                        ...
                        serverSide: true,
                        ajax: {
                            "url": "<?= site_url('laporan/laporan_pengumuman'); ?>",
                            "type": "POST"
                        },
                        columns: [{
                                "data": "id_informasi",
