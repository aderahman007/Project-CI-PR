...
function skorNilai($nilai,$sks)
 ...
 function ambilKRS($ipSemesterLalu , $jmlSksDiambil){
	 
	if($ipSemesterLalu >= 3.50) $SksDiambil = 24;
	    else if($ipSemesterLalu <= 3.49 AND $ipSemesterLalu >= 3.00) $SksDiambil = 22;					
			else if($ipSemesterLalu <= 2.99 AND $ipSemesterLalu >= 2.50) $SksDiambil = 20;
