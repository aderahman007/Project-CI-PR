...
class Users_model extends CI_Model
{
   ...
   function __construct()
    ...
    function json() {
        ...
        $this->datatables->select('users.username, users.password, users.email, users.level, users.blokir, users.id_sessions, siswa.nama_lengkap');
        $this->datatables->from('users,siswa');  
		$this->datatables->where('users.username = '. $username);	
		$this->datatables->where('users.username = siswa.nim');	
