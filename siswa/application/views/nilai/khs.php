	...
	<div class="box">
		<div class="box-body">
			...
			<center>
				...
				<?php
				echo anchor(site_url('nilai/cetak_nilai/' . $siswa_nim . '/' . $kode_angkatan), 'Cetak Nilai', 'class="btn btn-info al"');
				?>
			</center>
