		...
		<div class="box-body">
			...
			<form role="form" class="form-horizontal" action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
				...
				<div class="form-group">
					<label class="col-sm-2" for="char">NIS</label>
					<div class="col-sm-4">
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						...
						$query = $this->db->query('SELECT kelas.id_kelas, kelas.nama_kelas FROM kelas, siswa WHERE siswa.nim = ' . $username . ' AND siswa.id_kelas = kelas.id_kelas');
						$dropdowns = $query->result();

						foreach ($dropdowns as $dropdown) {
						?>
							<input type="text" class="form-control" placeholder="Kelas" value="<?php echo $dropdown->nama_kelas; ?>" readonly />
							<input type="text" name="id_kelas" id="id_kelas" placeholder="Kelas" value="<?php echo $dropdown->id_kelas; ?>" hidden />
						<?php
						}
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						...
						?>
							<div>
								<img src="<?=base_url()?>../administrator/images/<?php echo $photo; ?>">
							</div><br />
						<?php
						}
						?>
